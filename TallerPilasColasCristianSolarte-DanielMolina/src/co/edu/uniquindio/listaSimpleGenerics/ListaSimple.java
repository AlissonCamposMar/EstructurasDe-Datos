package co.edu.uniquindio.listaSimpleGenerics;
...
//				nodoUltimo = null;
	...
	/*Función recursiva que invierte la lista simple.
	 * @param 
	 */
	public ListaSimple<T> invertirLista(ListaSimple<T> lista, Nodo nodo) {
		try {
			if (!nodo.equals(nodoUltimo)) {
				Nodo nodoAux = nodo.getSiguienteNodo();
				lista.eliminar((T) nodoAux.getValorNodo());
				lista.agregarInicio((T) nodoAux.getValorNodo());
