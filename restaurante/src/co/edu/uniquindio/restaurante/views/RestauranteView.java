...
public class RestauranteView extends ApplicationWindow {
	...
	protected Control createContents(Composite parent) {
		...
		EmpleadoView composite = new EmpleadoView(tabFolder, SWT.NONE);
		tbtmEmpleado.setControl(composite);
		
		TabItem tbtmCliente = new TabItem(tabFolder, SWT.NONE);
		tbtmCliente.setText("Cliente");
		
		ClienteView composite_1 = new ClienteView(tabFolder, SWT.NONE);
