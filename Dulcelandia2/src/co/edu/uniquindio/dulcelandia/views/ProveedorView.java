...
public class ProveedorView extends Composite {
	...
	public ProveedorView(Composite parent, int style) {
		...
		Button btnEliminarProveedor = new Button(grpProveedoresYProductos, SWT.NONE);
		...
		btnEliminarProveedor.setBounds(437, 24, 107, 25);
		...
		btnExportar.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					String texto = ArchivoUtil.generarTexto("archivoProveedores.txt");
		...
		btnExportar.setBounds(429, 111, 75, 25);
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableMap[] observeMaps = PojoObservables.observeMaps(listContentProvider.getKnownElements(), Proveedor.class, new String[]{"nombre", "cedula", "telefono", "email"});
