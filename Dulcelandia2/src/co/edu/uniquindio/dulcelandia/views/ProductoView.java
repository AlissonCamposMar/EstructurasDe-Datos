...
public class ProductoView extends Composite {
	...
	public ProductoView(Composite parent, int style) {
		...
		btnActualizarProducto.setBounds(297, 125, 110, 25);
		btnActualizarProducto.setText("Actualizar producto");
		
		Button btnExportar = new Button(grpInformacin, SWT.NONE);
		btnExportar.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				try {
					String texto = ArchivoUtil.generarTexto("archivoProductos.txt");
		...
		btnExportar.setBounds(453, 125, 75, 25);
