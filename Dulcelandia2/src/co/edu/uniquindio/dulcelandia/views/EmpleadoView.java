...
public class EmpleadoView extends Composite {
	...
	public EmpleadoView(Composite parent, int style) {
		...
		grpInformacionDeEmpleados.setBounds(10, 245, 576, 174);
		...
		btnActualizarEmpleado.setBounds(289, 132, 113, 25);
		
		Button btnExportar = new Button(grpInformacionDeEmpleados, SWT.NONE);
		btnExportar.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				try {
					String texto = ArchivoUtil.generarTexto("archivoEmpleados.txt");
		...
		btnExportar.setBounds(425, 132, 75, 25);
