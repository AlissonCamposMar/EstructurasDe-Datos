...
public class ModelFactoryController extends Thread implements IModelFactoryService {
	...
	public ModelFactoryController() {
		...
		Persistencia.guardaRegistroLog("Inicio de sesión del usuario", 1, "Inicio de sesion");
	}
	 ...
	 * 
	 * 
	 * try { Persistencia.guardarProductos(getTienda().getListaProductos());
	...
	public void inicializarDatos() throws FileNotFoundException, IOException {
		tienda = new Tienda();
		tienda.setListaProductos(Persistencia.cargarProductos());
		tienda.setListaClientes(Persistencia.cargarClientes());
		tienda.setListaEmpleados(Persistencia.cargarEmpleados());
		tienda.setListaProveedores(Persistencia.cargarProveedores());

		/*
		 * Producto producto = new Producto();
		 * producto.setNombreProducto("Barrilete");
		 * producto.setCantidadExistente("10"); producto.setCodigo("4321");
		 * producto.setPrecio("200"); tienda.getListaProductos().add(producto);
		 * 
		 * producto = new Producto(); producto.setNombreProducto("Bombon");
		 * producto.setCantidadExistente("4"); producto.setCodigo("1234");
		 * producto.setPrecio("400"); tienda.getListaProductos().add(producto);
		 * 
		 * Cliente cliente = new Cliente(); cliente.setNombre("Marta");
		 * cliente.setCedula("456"); cliente.setTelefono("3135625983");
		 * cliente.setEmail("marta@gmail.com");
		 * tienda.getListaClientes().add(cliente);
		 * 
		 * cliente = new Cliente(); cliente.setNombre("Camilo");
		 * cliente.setCedula("789"); cliente.setTelefono("3105626983");
		 * cliente.setEmail("camilo@gmail.com");
		 * tienda.getListaClientes().add(cliente);
		 * 
		 * Empleado empleado = new Empleado(); empleado.setNombre("Juan");
		 * empleado.setCedula("123"); empleado.setTelefono("315566983");
		 * empleado.setEmail("juan@gmail.com");
		 * tienda.getListaEmpleados().add(empleado);
		 * 
		 * Proveedor proveedor = new Proveedor(); proveedor.setNombre("Mateo");
		 * proveedor.setCedula("498"); proveedor.setTelefono("315565983");
		 * proveedor.setEmail("mateo@gmail.com");
		 * tienda.getListaProveedores().add(proveedor);
		 * 
		 * Usuario usuario = new Usuario(); usuario.setUsuario("carlos");
		 * usuario.setContraseña("1234");
		 * tienda.getListaUsuarios().add(usuario);
		 * 
		 * usuario = new Usuario(); usuario.setUsuario("juan");
